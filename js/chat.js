...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      title: 'Юка · AI-консультант',
      status: 'Онлайн · отвечает сразу',
      hello: 'Здравствуйте! Я Юка, AI-сотрудник Juka Media. Подскажу по услугам, ценам и срокам — например, про сайт, магазин за €990 или рекламу в Google. Что вас интересует?',
