...
## Важно
- Сайт активно развивается; правки согласовываются с Алексеем в чате
...
## Web Dev Defaults (правила Алексея)
- Анимации: в этом проекте (vanilla HTML/CSS/JS) — CSS-анимации и лёгкий JS в духе
  существующих (reveal, aurora); framer-motion — только в React-проектах.
